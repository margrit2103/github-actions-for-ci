...
--      3.4  Check that the total turnover is zero on debtors and creditors

\echo ---------------------------------------------------------------------- 
\echo Test 3 (reverse codes not linked to assistant, then all codes linked to assistant) 
\echo ---------------------------------------------------------------------- 
\echo 3.1  Post invoice with 5 assistant codes 
...
\echo 3.2  Reverse codes not linked to assistant
WITH _answ AS 
     (SELECT tariffs.post_xml(format('<table>
                                                        ...
                                                        <credit_notes>
                                                            <credit_note>
                                                                ...
                                                                <note_varchar>TEST3 Reversal non assistant rows</note_varchar>
...
\echo 3.3  Reverse codes all codes linked to assistant
     ...
     (SELECT tariffs.post_xml(format('<table>
                                                        ...
                                                        <credit_notes>
                                                            <credit_note>
                                                                ...
                                                                <systemdate_date>%2$s</systemdate_date>
                                                                <period_integer>%1$s</period_integer>
                                                                <note_varchar>TEST3 Reversal all assistant rows</note_varchar>
                                                                <account_type_integer>3</account_type_integer>
                                                                <row>
...
\echo 3.4  Check that the total turnover is zero on debtors and creditors
