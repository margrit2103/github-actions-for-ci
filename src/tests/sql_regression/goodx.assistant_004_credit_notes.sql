...
\echo ---------------------------------------------------------------------- 
\echo Test 4  (reverse codes not linked to assistant, single linked to assistant, remaining codes linked to assistant) 
\echo ---------------------------------------------------------------------- 
\echo 4.1  Post invoice with 5 assistant codes 
...
\echo 4.2  Reverse codes not linked to assistant
WITH _answ AS 
     (SELECT tariffs.post_xml(format('<table>
                                                        ...
                                                        <credit_notes>
                                                            <credit_note>
                                                                ...
                                                                <note_varchar>TEST4 Reversal non assistant rows</note_varchar>
...
\echo 4.3  Reverse second code code linked to assistant
WITH _answ AS 
     (SELECT tariffs.post_xml(format('<table>
                                                        <global_data>
                                                            <a_id_integer>1</a_id_integer>
                                                        ...
                                                        <credit_notes>
                                                            <credit_note>
                                                                ...
                                                                <systemdate_date>%2$s</systemdate_date>
                                                                <period_integer>%1$s</period_integer>
                                                                <note_varchar>TEST4 Reversal row 6</note_varchar>
                                                                <account_type_integer>3</account_type_integer>
                                                                <row>
...
\echo 4.4  Reverse remaining codes code linked to assistant
     ...
     (SELECT tariffs.post_xml(format('<table>
                                                        ...
                                                        <credit_notes>
                                                            <credit_note>
                                                                ...
                                                                <systemdate_date>%2$s</systemdate_date>
                                                                <period_integer>%1$s</period_integer>
                                                                <note_varchar>TEST4 Reversal remaining assistant rows</note_varchar>
                                                                <account_type_integer>3</account_type_integer>
                                                                <row>
...
\echo 4.5.  Check that the total turnover is zero on debtors and creditors
